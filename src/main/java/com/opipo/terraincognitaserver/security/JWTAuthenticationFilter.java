...
import static com.opipo.terraincognitaserver.security.Constants.ISSUER_INFO;
import static com.opipo.terraincognitaserver.security.Constants.TOKEN_EXPIRATION_TIME;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
        ...
        String token = Jwts.builder().setIssuedAt(new Date()).setIssuer(ISSUER_INFO)
                ...
                .claim(UserDetailsServiceImpl.ROLES_FIELD_NAME, new Gson().toJson(auth.getAuthorities()))
