...
import static com.opipo.terraincognitaserver.security.Constants.LOGIN_URL;
...
public class WebSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        /*
         * 1. Se desactiva el uso de cookies 2. Se activa la configuración CORS con los valores por defecto 3. Se
         * desactiva el filtro CSRF 4. Se indica que el login no requiere autenticación 5. Se indica que el resto de
         * URLs esten securizadas
         */
        httpSecurity.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and().cors().and()
                ...
                .permitAll().antMatchers("/role/**").hasRole("ROLEMANAGER").antMatchers("/role**")
                .hasRole("ROLEMANAGER").anyRequest().authenticated().and()
